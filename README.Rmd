...
The mainteiner of the R package is Jakub Jędrusiak and the technical concerns should be directed to him. Well, me. Best way is to open an [issue on GitHub](https://github.com/jakub-jedrusiak/mtscr/issues).